  ...
  >
    <div class="flex items-start gap-2">
      ...
      <div>
        ...
        <p class="text-sm">
          If hosting on a serverless platform (e.g., Vercel), <a href="/admin/settings/cloud-storage" class="underline font-medium hover:text-blue-800">Cloud Storage must be configured</a> before uploading logos or favicons. Serverless platforms have read-only filesystems.
        </p>
      </div>
    </div>
  </div>
